    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
         ...
         try
         {
            ...
            for(u=0;u<fn;u++)
            {
             ...
             int minm = (otarr[0]*100)/ttarr[0];
             int max = (otarr[0]*100)/ttarr[0];
             wktp = tarr[0];
             ...
             t = (Topic)session.get(Topic.class, tp);
              ...
              if(pa<minm)
              {
                  minm = (otarr[u]*100)/ttarr[u];
                  wktp = tarr[u];

              }
              if(pa>max)
              {
                  max = (otarr[u]*100)/ttarr[u];
                  stp = tarr[u];
             ...
             request.setAttribute("marks", omarks);
              request.setAttribute("total", tm);
              hs.setAttribute("m", m);
