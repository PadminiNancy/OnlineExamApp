...
<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
            ...
            int fn =  ((Integer)(hs.getAttribute("final"))).intValue();
             ...
             int q = (((Integer)request.getAttribute("sno")).intValue());
  ...
  function c3()
{
  ...
  function getAns(arg)
  {
    ...
    document.getElementById('ans').style="background: #99CC99";
    ...
    <body background="images/back.jpg">
        ...
        <html:form action="ResultServ.do" method="post" >
            ...
            <tbody style=" font-size:large;">
                ...
                <% if(qphoto!=null) {
                %>
                <td> <img src="qphoto/${requestScope.curquest.qid}.jpg" height="400px" width="400px"/></td>
                ...
                <table>
                    <tbody> <tr>
                    <td>  
                        <input type="button"  style=" color:#CC0066; background: #99CC99;font-size:large;width:80px;border-radius:5px;" value="Previous" name="B1" onclick="c1(); ">
                    </td>  <td input type="hidden" style=" width:20px;height:0px;"></td>
                    <td>  <input type="button" style=" color:#CC0066; background: #99CC99;font-size:large;width:80px;border-radius:5px;" value="Next" name="B2" onclick="c2();">
                    </td>  <td input type="hidden" style=" width:300px;height:0px;"></td>
                    <td>  <input type="submit" style=" color:#CC0066; background: #99CC99;font-size:large;width:80px;border-radius:5px;" value="Submit" /></td>
                    </tr>         </tbody>
                </table>
                </tr>
            </tbody>
